...
ATTRS = dict(
    ...
    plugin_file = attr.label(
        default = Label("@build_bazel_rules_nodejs//@bazel/cypress:internal/plugins/base.js"),
        allow_single_file = True,
...
def _cypress_web_test_impl(ctx):
    ...
    cypressinfo = ctx.toolchains[Label("//@bazel/cypress/internal/toolchain:toolchain_type")].cypressinfo
...
toolchain_type_label = Label("//@bazel/cypress/internal/toolchain:toolchain_type")
