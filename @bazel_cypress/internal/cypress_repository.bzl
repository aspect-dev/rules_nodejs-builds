...
cypress_repository = repository_rule(
    ...
    attrs = {
        ...
        "_base_plugin": attr.label(
            allow_single_file = True,
            default = "//@bazel/cypress:internal/plugins/base.js",
        ),
        "_cypress_web_test": attr.label(
            allow_single_file = True,
            default = "//@bazel/cypress:internal/template.cypress_web_test.bzl",
        ),
        "_install_cypress": attr.label(
            allow_single_file = True,
            default = "//@bazel/cypress:internal/install-cypress.js",
        ),
    },
)
