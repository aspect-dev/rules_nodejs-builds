...
_cypress_plugin = rule(
    ...
    attrs = {
        ...
        "plugins_file": attr.label(
            default = Label("TEMPLATED_node_modules_workspace_name//@bazel/cypress:internal/plugins/base.js"),
        ...
        "_plugin_template": attr.label(
            default = Label("TEMPLATED_node_modules_workspace_name//@bazel/cypress:internal/plugins/index.template.js"),
            allow_single_file = True,
        ),
    },
)
...
def cypress_web_test(
        ...
        tar = Label("TEMPLATED_node_modules_workspace_name//@bazel/cypress"),
        **kwargs):
    ...
    nodejs_test(
        ...
        entry_point = "TEMPLATED_node_modules_workspace_name//@bazel/cypress:internal/run-cypress.js",
        templated_args = [
...
def cypress_web_test_global_cache(
        ...
        config_file,
        srcs = [],
        plugins_file = Label("@build_bazel_rules_nodejs//@bazel/cypress:plugins/base.js"),
