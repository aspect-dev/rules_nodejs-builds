...
def npm_bazel_labs_dependencies():
    ...
    yarn_install(
        ...
        package_json = Label("//@bazel/labs/grpc_web:package.json"),
        yarn_lock = Label("//@bazel/labs/grpc_web:yarn.lock"),
    ...
    yarn_install(
        ...
        package_json = Label("//@bazel/labs/protobufjs:package.json"),
        yarn_lock = Label("//@bazel/labs/protobufjs:yarn.lock"),
        # Do not symlink node_modules as when used in downstream repos we should not create
        # node_modules folders in the external repository. This is
        # not supported by managed_directories.
        symlink_node_modules = False,
